package com.loveis.demo.module.codegroup;
...
public class CodeGroupDto {
	...
	public void setCogrDisc(String cogrDisc) {
		this.cogrDisc = cogrDisc;
	}
	public String getCogrRegDate() {
		return cogrRegDate;
	}
	public void setCogrRegDate(String cogrRegDate) {
		this.cogrRegDate = cogrRegDate;
	}
	public String getCogrModDate() {
		return cogrModDate;
	}
